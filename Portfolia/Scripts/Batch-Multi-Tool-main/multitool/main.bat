...
echo.
echo.
echo [38;2;255;255;0m        ╔═(1) Vmware Workstation Pro[0m  
echo [38;2;255;255;0m        ║[0m  
echo [38;2;255;255;0m        ╠══(2) Wireshark[0m  
echo [38;2;255;255;0m        ║[0m  
echo [38;2;255;255;0m        ╠═══(3) Virtualbox[0m  
echo [38;2;255;255;0m        ║[0m  
echo [38;2;255;255;0m        ╠═══(4) IP SCANER[0m
echo [38;2;255;255;0m        ║[0m 
echo [38;2;255;255;0m        ╠═══(5) WinSCP[0m
echo [38;2;255;255;0m        ║[0m 
echo [38;2;255;255;0m        ╚╦═══(6) Putty[0m  
echo [38;2;255;255;0m         ║[0m  
set /p input=.%BS% [38;2;255;255;0m        ╚══════^>[0m  
if /I %input% EQU 1 start VMW.lnk
if /I %input% EQU 2 start Wireshark.lnk
if /I %input% EQU 3 start vbox.lnk
if /I %input% EQU 4 start IP.lnk
if /I %input% EQU 5 start WS.lnk
if /I %input% EQU 6 start putty.exe
cls
goto start
